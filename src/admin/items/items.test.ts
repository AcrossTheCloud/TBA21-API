...
describe('Admin Items', () => {
  ...
  test('Get item with a specific s3 key', async () => {
    const
      ...
      result = JSON.parse(response.body);
    expect(result.data.objects.output.geometries[0].properties.s3_key).toEqual('private/eu-central-1:80f1e349-677b-4aed-8b26-896570a8073c/ad742900-a6a0-11e9-b5d9-1726307e8330-rat-pet-animal-domestic-104827.jpeg');
  });
