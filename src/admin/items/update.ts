    ...
    await Joi.validate(data, Joi.object().keys(
      {
        ...
        place: Joi.array().items(Joi.string().allow('').allow(null)),
        ...
        speakers: Joi.array().items(Joi.string().allow('').allow(null)),
        performers: Joi.array().items(Joi.string().allow('').allow(null)),
        ...
        organisation: Joi.array().items(Joi.string().allow('').allow(null)),
        ...
        produced_by: Joi.array().items(Joi.string().allow('').allow(null)),
        ...
        volume: Joi.number(),
        provenance: Joi.array().items(Joi.string().allow('').allow(null)),
